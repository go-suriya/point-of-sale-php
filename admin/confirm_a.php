          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
              <form id="frmcart" name="frmcart" method="post" action="saveorder_a.php">
                <?php if ($_id != '') : ?>
                  <h4>
                    ยืนยันรายการสั่งซื้อ<br>
                    ผู้ซื้อ: <?= $row_member['mem_name']; ?> <br>
                    Address: <?= $row_member['mem_address']; ?>
                  </h4>
                <?php endif; ?>
                ...
                <table border="0" align="center" class="table table-hover table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        <td><?= $i; ?></td>
                        <td><img src="../p_img/<?= $row['p_img']; ?>" width="100%"></td>
                        <td>
                          <?= $row['p_name']; ?><br>
                          สต๊อก <?= $pqty; ?> รายการ
                        </td>
                        ...
                        <td align="right">
                          <input type="number" name="amount[<?= $p_id; ?>]" value="<?= $qty; ?>" size="2" class="form-control" min="0" max="<?= $pqty; ?>" readonly />
                        </td>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td align="center"><b>ราคารวม</b></td>
                      <td align="right" colspan="2"><b><?= number_format($total, 2); ?></b></td>
                    </tr>
                  <?php
                  }
                  ?>
