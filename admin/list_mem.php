            ...
            <tbody>
              <?php foreach ($rs_member as $row_member) { ?>
                <tr>
                  ...
                  <td>
                    <a href="member_db.php?mem_id=<?php echo $row_member['mem_id']; ?>&&member=del" class="del-btn btn btn-danger" onclick="return confirm('ต้องการลบข้อมูลนี้ใช่หรือไม่!')">
                      <i class="fas fas fa-trash"></i> del</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
